...
cons_recursivo_form AS ( SELECT FORMULARIO_PK
                              ...
                              WHERE FORMULARIO_PK IN ( 979  ) -- ADMINISTRACION_QUIMIOTERAPIA_ENFERMERIA
                         UNION ALL
...
EXECUTE IMMEDIATE FORMAT(""" CREATE OR REPLACE TABLE `ci-datalake-dev.ci_dtlk_bqd_staging_dev_RNC.FORM_ADMINISTRACION_QUIMIOTERAPIA_ENFERMERIA` AS %s """, sql);
