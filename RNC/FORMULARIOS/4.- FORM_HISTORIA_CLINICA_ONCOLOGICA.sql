...
cons_recursivo_form AS ( SELECT FORMULARIO_PK
                              ...
                              WHERE FORMULARIO_PK IN ( 978  ) -- HISTORIA_CLINICA_ONCOLOGICA
                         UNION ALL
...
EXECUTE IMMEDIATE FORMAT(""" CREATE OR REPLACE TABLE `ci-datalake-dev.ci_dtlk_bqd_staging_dev_RNC.FORM_HISTORIA_CLINICA_ONCOLOGICA` AS %s """, sql);
