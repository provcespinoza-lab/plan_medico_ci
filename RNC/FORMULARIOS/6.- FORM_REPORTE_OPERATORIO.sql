...
cons_recursivo_form AS ( SELECT FORMULARIO_PK
                              ...
                              WHERE FORMULARIO_PK IN ( 1552 ) -- REPORTE_OPERATORIO
                         UNION ALL
...
EXECUTE IMMEDIATE FORMAT(""" CREATE OR REPLACE TABLE `ci-datalake-dev.ci_dtlk_bqd_staging_dev_RNC.FORM_REPORTE_OPERATORIO` AS %s """, sql);
