...
cons_recursivo_form AS ( SELECT FORMULARIO_PK
                              ...
                              WHERE FORMULARIO_PK IN ( 883 ) -- EPICRISIS_INFORME_ALTA
                         UNION ALL
...
EXECUTE IMMEDIATE FORMAT(""" CREATE OR REPLACE TABLE `ci-datalake-dev.ci_dtlk_bqd_staging_dev_RNC.FORM_EPICRISIS_INFORME_ALTA` AS %s """, sql);
